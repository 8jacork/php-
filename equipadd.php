...
<form method="post" action="equipadd.php"> <table align="center">
<input name="action" value="equipadd" type="hidden" />
<tr>
<td>设备编号：</td>
<td><input name="a" type="text" /></td>
</tr>
<tr>
<td>设备名称：</td><td><input name="b" type="text" /></td>
</tr>
<tr>
<td>设备价格：</td><td><input name="c" type="text" /></td>
<tr>
<td>图片：</td><td><input name="d" type="text" /></td>
</tr>
</tr>
<tr>
<td>小时/价格：</td><td><input name="e" type="text" /></td>
</tr>
<tr>
...
error_reporting(E_ALL&~E_NOTICE);
	...
	if($_POST['action']=="equipadd"){
	if(!($_POST['a'] and $_POST['b'] and $_POST['c'] and $_POST['c'] and $_POST['d'])){
		echo"输入不允许为空。单击<a href='javascript:onclick=history.go(-1)'>这里</a>返回";	
		
	}else{
		$sqlstr1="insert into equip values('".$_POST['a']."','".$_POST['b']."','".$_POST['c']."','".$_POST['d']."','".$_POST['d']."')";
