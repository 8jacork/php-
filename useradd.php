...
<form method="post" action="useradd.php"> <table align="center">
<input name="action" value="useradd" type="hidden" />
<tr>
<td>用户账号：</td>
<td><input name="ID" type="text" /></td>
</tr>
<tr>
<td>用户密码：</td><td><input name="pwd" type="text" /></td>
</tr>
<tr>
<td>用户昵称：</td><td><input name="ni" type="text" /></td>
</tr>
<tr>
<td>用户姓名：</td><td><input name="name" type="text" /></td>
</tr>
<tr>
<td>用户手机号：</td><td><input name="phone" type="text" /></td>
</tr>
<tr>
...
error_reporting(E_ALL&~E_NOTICE);
	...
	if(!($_POST['ID']and$_POST['pwd']and$_POST['ni']and$_POST['name'])){
		echo"输入不允许为空。单击<a href='javascript:onclick=history.go(-1)'>这里</a>返回";	
		
	}else{
		$sqlstr1="insert into user values('".$_POST['ID']."','".$_POST['pwd']."','".$_POST['ni']."','".$_POST['name']."','".$_POST['phone']."')";
